...
namespace Platformer2D.Character
{
    ...
    public class CharacterMovement2D : MonoBehaviour
    {
        ...
        [Range(0.0f, 1.0f)]
        [SerializeField] float dashGroundSpeedPercent = 0.3f;
        ...
        CharacterFacing2D characterFacing;
        ...
        {
            get { return groundMaxSpeed * (IsDashing ? dashGroundSpeedPercent : 1.0f); }
        ...
        {
            return IsGrounded && !IsJumping && !IsDashing;
        }
        ...
        public void Dash()
        {
            ...
            SetCapsuleHeight(ColliderInfo.Size.y * dashCapsuleHeightPercent);
        }
        ...
        bool CanUncrouch()
        {
            return IsDashing && CheckCapsuleCollisionsTop() == false;
        }
